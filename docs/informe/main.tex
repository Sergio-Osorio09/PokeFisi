...
diferencias de aptitud reflejan los pesos y no la suerte. El ciclo evolutivo
...
Como trabajo futuro proponemos: evaluar el \emph{fitness} del genético contra un
panel de rivales o mediante auto-juego (para evitar el sobreajuste observado);
sustituir la formulación \emph{paranoid} por una que capture la simultaneidad
(p.\,ej.\ equilibrios de estrategia mixta) sin renunciar a la poda alfa-beta;
ampliar los tamaños de muestra para estrechar los intervalos de confianza; y
enriquecer el modelo con estados de alteración y mayor estocasticidad.
